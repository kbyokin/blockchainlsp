...
VERSION="1"
CC_SRC_PATH="./artifacts/chaincode/orderinfo"
CC_NAME="orderinfo"
...
CC_RUNTIME_LANGUAGE="node"
VERSION="1"
CC_SRC_PATH="./artifacts/chaincode/workinfo"
CC_NAME="workinfo"
...
CC_RUNTIME_LANGUAGE="node"
VERSION="1"
CC_SRC_PATH="./artifacts/chaincode/jobassignmentinfo"
CC_NAME="jobassignmentinfo"
...
# export CORE_PEER_TLS_ENABLED=true
# export ORDERER_CA=${PWD}/artifacts/channel/crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
# export PEER0_ORG1_CA=${PWD}/artifacts/channel/crypto-config/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/tls/ca.crt
# # export PEER0_ORG2_CA=${PWD}/artifacts/channel/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
# export FABRIC_CFG_PATH=${PWD}/artifacts/channel/config/
...
#         --peerAddresses localhost:10051 --tlsRootCertFiles $PEER0_ORG1_CA \
#         --version ${VERSION} --sequence ${VERSION} --init-required
...
#         -C $CHANNEL_NAME -n ${CC_NAME} \
#         --peerAddresses localhost:8051 --tlsRootCertFiles $PEER0_ORG1_CA \
#         -c '{"function": "JobassignmentInfo","Args":["job005", "", ""]}'
...
#     # Query Car by Id
#     peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "queryAllJobassignmentInfo","Args":[]}'
#     #'{"Args":["GetSampleData","Key1"]}'
