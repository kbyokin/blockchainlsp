...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        -C $CHANNEL_NAME -n ${CC_NAME} \
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        -c '{"function": "createdeliveryinfo","Args":["", "JOB541", "200", "3", "peer3"]}'
...
chaincodeQuery() {
    ...
    # Query Car by Id
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "queryAllloadingInfo","Args":[]}'
...
CC_RUNTIME_LANGUAGE="node"
VERSION="1"
CC_SRC_PATH="./artifacts/chaincode/myjobassignment"
CC_NAME="myjobassignment"
...
CC_RUNTIME_LANGUAGE="node"
VERSION="1"
CC_SRC_PATH="./artifacts/chaincode/loadinginfo"
CC_NAME="loadinginfo"
...
CC_RUNTIME_LANGUAGE="node"
VERSION="1"
CC_SRC_PATH="./artifacts/chaincode/deliveryinfo"
CC_NAME="deliveryinfo"
...
CC_RUNTIME_LANGUAGE="node"
VERSION="1"
CC_SRC_PATH="./artifacts/chaincode/subjobassignment"
CC_NAME="subjobassignment"
